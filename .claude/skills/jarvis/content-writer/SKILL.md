...
- Don't specify style → Uses Sid's voice (DEFAULT)
- Specify style → Applies that creator's voice pattern
- See [reference/twitter-pattern-analysis.md](reference/twitter-pattern-analysis.md) and [reference/social-media-best-practices.md](reference/social-media-best-practices.md) for voice details
...
- **[prompts/long-form-youtube.md](prompts/long-form-youtube.md)** - YouTube scripts (Ali Abdaal, MKBHD patterns)
- **[prompts/short-form-vertical.md](prompts/short-form-vertical.md)** - Shorts/Reels/TikTok scripts
- **[prompts/substack-newsletter.md](prompts/substack-newsletter.md)** - Newsletter generation (Paul Graham essay style)

### Reference Files

- **[reference/social-media-best-practices.md](reference/social-media-best-practices.md)** - Complete research compilation from Justin Welsh, Twitter formulas, Paul Graham, Substack strategies
- **[reference/twitter-pattern-analysis.md](reference/twitter-pattern-analysis.md)** - Deep analysis of Greg Isenberg & deedydas voice patterns with proven engagement data
- **[reference/youtube-best-practices.md](reference/youtube-best-practices.md)** - YouTube optimization strategies and retention tactics
...
- **[examples/ali-abdaal-top5-example.md](examples/ali-abdaal-top5-example.md)** - Ali Abdaal educational script
- **[examples/mkbhd-tech-review-example.md](examples/mkbhd-tech-review-example.md)** - MKBHD tech review script
- **[examples/short-form-60s-example.md](examples/short-form-60s-example.md)** - 60-second vertical video

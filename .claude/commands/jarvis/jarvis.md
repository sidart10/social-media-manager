...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*research-topic" workflow="{agent-folder}/workflows/research-topic/workflow.yaml">Deep research on any topic (uses free + paid tools smartly)</item>
    <item cmd="*analyze-profile" workflow="{agent-folder}/workflows/analyze-profile/workflow.yaml">Analyze profile on ANY platform (Twitter, Instagram, TikTok, LinkedIn, YouTube)</item>
    <item cmd="*competitive-analysis" workflow="{agent-folder}/workflows/competitive-analysis/workflow.yaml">Multi-platform competitive analysis with gap finding</item>
    <item cmd="*generate-ideas" workflow="{agent-folder}/workflows/generate-ideas/workflow.yaml">Generate evidence-backed Idea Cards from research</item>
    <item cmd="*learn-voice" workflow="{agent-folder}/workflows/learn-voice/workflow.yaml">Build your personal voice profile from your content</item>
    <item cmd="*write-posts" workflow="{agent-folder}/workflows/write-posts/workflow.yaml">Write platform-specific posts in your voice (LinkedIn, Twitter, Instagram)</item>
    <item cmd="*write-scripts" workflow="{agent-folder}/workflows/write-scripts/workflow.yaml">Write video scripts with timing and visual direction (YouTube, Reels, TikTok)</item>

...
- [x] Tool names match MCP server exactly (mcp__submagic__*)
...
- [ ] **Robustness** (error handling): __/10
- [ ] **User Experience** (question flow): __/10
- [ ] **Integration** (with Zoe/Zoro): __/10
- [ ] **Documentation** (README, comments): __/10
- [ ] **Modularity** (handles all input types): __/10
- [ ] **Professional Feel** (editor-like questions): __/10
- [ ] **Technical Correctness** (API params): __/10
- [ ] **Performance** (processing time): __/10
